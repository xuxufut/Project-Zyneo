      ...
      <div className="max-w-6xl mx-auto px-6 py-10 space-y-8">
        <header className="space-y-4">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button
              type="button"
              className="rounded-xl border border-blue-200 bg-white px-4 py-2 text-sm font-semibold text-blue-600 transition hover:border-blue-300 hover:bg-blue-50"
            >
              Lihat Jadwal Rental
            </button>
          </div>
                ...
                <tbody className="text-slate-700">
                  {filteredPlaystations.length === 0 ? (
                    <tr>
                      ...
                      >
                        Paket tidak ditemukan. Coba ubah kata kunci atau filter.
                      </td>
                    </tr>
                  ) : (
                    filteredPlaystations.map(ps => (
                      ...
                      >
                        ...
                        <td className="py-4 pr-4">{ps.controllers} unit</td>
                        <td className="py-4 pr-4">
